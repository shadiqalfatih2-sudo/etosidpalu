  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.actions}>
        <Link className={styles.primaryButton} href="/native-preview/kirim-tulisan">Kirim Tulisan</Link>
        <Link className={styles.secondaryButton} href="/native-preview/admin">Admin</Link>
      </div>
    </header>
  );
}
